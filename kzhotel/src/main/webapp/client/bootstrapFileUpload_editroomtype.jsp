...
<body>
    ...
    <script src="${pageContext.request.contextPath }/js/bsupload/zh.js" type="text/javascript"></script>
		...
		<input id="file-editroomtype" name="file" class="file" type="file" multiple data-min-file-count="1"/>
		<script>
	$("#file-editroomtype").fileinput({
	...
	$('#file-editroomtype').on('fileuploaded',function(event, data, previewId, index) {
		...
		reader = data.reader;
		parent.document.getElementById("roomTypeList_editPhoto").setAttribute("src",parent.eapor.data.bootStrapFileUploadUrl+"/upload/uploadRoomtype/"+ response.statusMsg);
