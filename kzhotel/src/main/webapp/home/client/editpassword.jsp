        ...
        <form method="post" class="form-horizontal" action="" autocomplete="off">
          <div class="form-group" style="height:56px;margin-bottom:10px;">
            ...
            <div class="col-md-8 col-xs-8 col-lg-8 col-sm-8" style="padding-left:0;">
              <input type="text" class="form-control" name="username" autocomplete="off" required placeholder="请输入用户名" />
            </div>
          </div>
          ...
          <div class="form-group" style="height:56px;margin-bottom:10px;">
            ...
            <div class="col-md-8 col-xs-8 col-lg-8 col-sm-8" style="padding-left:0;">
              <input type="password" class="form-control" name="oldpassword" autocomplete="off" required placeholder="请输入旧密码" />
            </div>
          </div>
          ...
          <div class="form-group" style="height:56px;margin-bottom:10px;">
            ...
            <div class="col-md-8 col-xs-8 col-lg-8 col-sm-8" style="padding-left:0;">
              <input type="password" class="form-control" name="newpassword" autocomplete="off" required placeholder="请输入新密码" />
            </div>
          </div>
