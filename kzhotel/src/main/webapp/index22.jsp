...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/home/js/login.js?v=20171211175543"></script>
    ...
    <div class="navbar navbar-inverse  "  style="background-color: white;" id="menu">
        <div class="container" >
            <div class="navbar-header"  style="width:230px;">
                ...
                <a tabindex="-1" class="navbar-brand" style="width: 80px;height: 80px;padding: 8px 0;" href="http://www.eapor.com">
				<img  style="width: 80px;height: 64px;" src="../home/images/eapolog.png" alt=""/>
                </a>
            ...
            <div class="navbar-collapse collapse move-me">
                <ul class="nav navbar-nav navbar-right">
                    <li  class="topTitle" style="color:#3D4E6A;padding:0 0 0 30px;"><a tabindex="-1" class="topTitleActive" style="width:34px;color:#3D4E6A;padding:20px 0 0 0;font-size:16px;text-indent:1px;cursor: default;">首页</a></li>
                     <li class="topTitle" style="color:#3D4E6A;padding:0;"><a tabindex="-1" class="topahover"  id="title_about" style="color:#3D4E6A;padding:20px 0 0 0;font-size:16px;cursor:pointer;text-indent:2px" >关于驿宝</a></li>
                     <li class="topTitle" style="color:#3D4E6A;padding:0;"><a tabindex="-1" class="topahover" id="title_lianxi" style="color:#3D4E6A;padding:20px 0 0 0;font-size:16px;cursor:pointer;text-indent:2px" >联系我们</a></li>
                    <li class="topTitle"  style="padding:0;"><a tabindex="-1" class="topahover" href="../home/client/useapplication.jsp" target="_blank" style="color:#3D4E6A;padding:20px 0 0 0;font-size:16px;text-indent:2px">使用申请</a></li>
                </ul>
            </div>
        </div>
    </div>
                      ...
                      <div class="flexslider set-flexi" id="main-section" >
                        ...
                        <div id="nocookie"  class="login-topBg">
                          <div class="login-topStyle" style="top: 0;right:0;">
       						<%-- <form id="loginForm" action="${pageContext.request.contextPath }/kzhotel/user/login" method="post"  autocomplete="off"> --%>
                            ...
                            <div class="input-group pdb10">
                              ...
                              <input id="username" class="iptname  form-control" type="text" name="username" aria-describedby="basic-addon1" tabindex="1" placeholder="请输入用户名"  autocomplete="off"/>
                            </div>
                            <div class="input-group pdb10" >
                              ...
                              <i id="showPWD" class="fa fa-eye-slash fa-lg  black" style="position: absolute;right: 10px; top:10px;z-index: 3;cursor: pointer;"></i>
                            </div>
                            <div>
                              ...
                              <div class="float-left">
							   <img alt="验证码"  tabindex="-1" style="width:100px;height:32px;margin-top:1px; margin-left: 8px;cursor:pointer;" id="verificationCode" src="${pageContext.request.contextPath }/kzhotel/validate/code">
                              </div>
                            </div>
                            <div class="clear"></div>
                             <div class="float-left mgb10">
                              ...
                              <div class="clear"></div>
                              <div>
                              	<!-- <span id="loginInfoIsExpired" class="error_xinxi" style="display:none;color: red;font-size: 120%;letter-spacing: 1px;">身份信息过期，请重新登录</span> 
                               	<span id="loginInfoIsNull" class="error_xinxi" style="display:none;color: red;font-size: 120%;letter-spacing: 1px;">登录信息不能为空</span> 
                                <span id="userError" class="error_xinxi" style="display:none;color: red;font-size: 120%;letter-spacing: 1px;">用户名或密码不正确</span> 
                                <span id="validateError" class="error_xinxi" style="display:none;color: red;font-size: 120%;letter-spacing: 1px;">验证码不正确</span> -->
